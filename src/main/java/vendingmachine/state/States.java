...
public enum States implements State {
	...
	WAITING {
		// TODO Create singleton that wraps System.out and use it where it is needed.
		// Extract the MessageDisplayer instead of declare it in every state.
	...
	SELECT {
		...
		private void processPaymentOperations(final Item item, final VendingMachine vendingMachine,
			...
			final List<Coin> change = paymentService.getChange(vendingMachine.getClientMoney().subtract(item.price));
